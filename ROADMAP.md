# Kelvin Capital Roadmap

## Phase 1: Foundation ✅ (COMPLETED)
- [x] Set up Raspberry Pi 5 infrastructure
- [x] Create Twitter account (@Kelvin_Capital_)
- [x] Build CSP scanner with Tradier API
- [x] Establish daily trading routine (9:35 AM / 3:30 PM)
...
- [ ] Achieve 5% portfolio return
- [ ] Document 10+ trades in spreadsheet
...
**P&L:** $0 (no trades yet)  
**Win Rate:** N/A  
**Next Milestone:** First CSP trade
